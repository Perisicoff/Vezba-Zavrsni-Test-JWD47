...
import NovoTakmicenje from './components/takmicenja/DodajTakmicenje';
              ...
              <Router>
                ...
                ATP Turniri
                  ...
                  <Nav className="navbar-links-center">
                    <Nav.Link className="text-white bg-dark" as={Link} to="/takmicenja">
                      Takmicenja
                    </Nav.Link>
                ...
                <Container style={{paddingTop:"25px"}}>
                  <Routes>
                    ...
                    <Route path="/takmicenja" element={<Takmicenja callBackF={(f) => setTakmicenjeId(f)}/>}/>
                    <Route path="/takmicenje/add" element={<NovoTakmicenje/>}/>
                    <Route path="/prijava/add" element={<Prijava takmicenje={takmicenjeId}/>}/>
